...
pure_prompt() {
    ps_prefix_1="${green}┌─${normal}";
    ps_prefix_2="${green}\n└─${normal}";
    ps_root_prefix_1="${red}┌─${normal}";
    ps_root_prefix_2="${red}\n└─${normal}";
    ...
    # make it work
    case $(id -u) in
        0) PS1="$ps_root_prefix_1$ps_root@$ps_host$(scm_prompt):$ps_path$ps_root_prefix_2$ps_root_mark"
            ;;
        *) PS1="$ps_prefix_1$ps_user@$ps_host$(scm_prompt):$ps_path$ps_prefix_2$ps_user_mark"
            ;;
    esac
}
